  ...
  return (
    <PanelShell
      ...
      nav={[
        ...
        ...(can("hosting") ? [{ title: t("Hosting"), items: [...Object.values(WORKLOAD_LABEL).map((l) => ({ href: l.path, label: t(l.many), icon: l.icon })), { href: "/client/updates", label: t("WordPress updates"), icon: "↻" }, ...(account.only ? [] : [{ href: "/client/domains", label: t("Domains"), icon: "◍" }, { href: "/client/dns", label: t("DNS management"), icon: "⇄" }])] }] : []),
        {
          title: t("Company"),
          items: [
